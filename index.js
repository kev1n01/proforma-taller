...
function generateTableRowJob() {
	...
	'<td style="display: none;"><span contenteditable>1</span></td>' +
	'<td style="display: none;"><span data-prefix>S/ </span><span>0.00</span></td>';
	return emptyColumn;
}
...
function onContentLoad() {
	...
	function onClick(e) {
		...
		} else if (e.target.matchesSelector('.add-job')) {
			document.querySelector('table.jobs tbody').appendChild(generateTableRowJob());
